...
<page>
  ...
  <table border="1" align="center">
    ...
    if (isset($_POST['cetak'])) {
      ...
      $query    = "SELECT * FROM tbl_tk_supplier INNER JOIN tbl_tk_barang ON tbl_tk_supplier.id_transaksi = tbl_tk_barang.id_transaksi WHERE (tbl_tk_barang.waktu BETWEEN '$tgla' AND '$tglb') ORDER BY waktu ASC";
