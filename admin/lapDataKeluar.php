...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      ...
      <a href="../laporan/cetakDataKeluar.php" class="btn btn-block btn-success col-sm-2 mt-3 mb-2" name="cetak" type="submit">Cetak Semua</a>
      <div class="row">
        <div class="col-md-2">
          <form action="../laporan/cetakDataKeluar.php" method="post" target="_blank">
