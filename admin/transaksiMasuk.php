...
<?php
$sql    = "SELECT id_transaksi FROM tbl_tm_supplier";
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card card-info">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal" action="transaksiMasukTambah.php" method="post">
          <div class="card-body">
            ...
            <center>
              ...
              <input type="submit" name="insert" class="btn btn-primary" value="Masuk" />
            </center>
          </div>
        </form>
      </div>
...
$(document).ready(function() {
  ...
  $(document).on('click', '#produk', function(e) {
	...
	$('#save').click(function(){
		...
		if($('').val() == '')
		{
			error_kode_barang = 'First Name is required';
		...
		if($('#nama_barang').val() == '')
		{
			error_nama_barang = 'Last Name is required';
		...
		{
			error_jumlah_barang = 'Last Name is required';
